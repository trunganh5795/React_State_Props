...
export default class BaiTapRenderWithMap extends Component {
    ...
    renderFilm = () => {
        const arrTagFilm = this.dataFilm.map((phim, index) => {
            return <div key={index} className="col-3 mt-2">
                <div className="card text-left">
                    <img width="150" height="300" className="card-img-top" src={phim.hinhAnh} alt={phim.hinhAnh} />
        ...
        console.log(arrTagFilm)
        return arrTagFilm;
    }


    render() {
        let a = this.renderFilm();
        console.log(a)
        return (
